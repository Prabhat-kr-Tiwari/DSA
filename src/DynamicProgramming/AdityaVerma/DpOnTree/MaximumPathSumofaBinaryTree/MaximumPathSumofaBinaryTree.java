package DynamicProgramming.AdityaVerma.DpOnTree.MaximumPathSumofaBinaryTree;
...
public class MaximumPathSumofaBinaryTree {
    ...
    static int solve(Node1 node) {
        ...
        int temp = Math.max(Math.max(l, r) + node.data,node.data); // Height of the current node
